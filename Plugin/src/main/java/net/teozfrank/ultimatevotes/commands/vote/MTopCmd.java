 ...
 */
public class MTopCmd extends VoteCmd {

    public MTopCmd(UltimateVotes plugin, String mainPerm) {
    ...
    public void run(final CommandSender sender, String subCmd, String[] args) {
        ...
        final String tableName = "MONTHLYVOTES";
        final String title = mm.getMVoteTopTitle();
        plugin.getServer().getScheduler().runTaskAsynchronously(plugin, new Runnable() {
            ...
            public void run() {
                ...
                if (playerVotes == 0) {
                    ...
                    Util.cmdTitle(sender, title);
                    String mTopMessage = mm.getMTopCmdMessage();
                    mTopMessage = mTopMessage.replaceAll("%votecount%", String.valueOf(playerVotes));
                    Util.sendVoteCountMessage(sender, ChatColor.translateAlternateColorCodes('&' , mTopMessage));
                    Util.sendPluginCredits(sender);
                    return;
                } else {
